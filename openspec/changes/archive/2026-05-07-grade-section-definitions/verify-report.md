...
The sidebar links are placed under the "Definiciones" section (alongside term-type definitions), which follows the established pattern for definition catalogs. No warnings remain.
