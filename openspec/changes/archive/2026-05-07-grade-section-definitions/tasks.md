...
- **Description**: Add two new conditional sidebar items under "Definiciones" section (alongside term-type definitions): "Definiciones de Grados" (grade_definitions.view gate, Book icon) and "Definiciones de Secciones" (section_definitions.view gate, Tag icon).
