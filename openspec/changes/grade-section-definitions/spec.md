...
The system MUST include a "Definiciones de Grados" link in the admin sidebar under the "Académico" section, visible only to users with `grade_definitions.view`.
