...
El sistema maneja cuatro roles: Administrador, Profesor, Estudiante y Representante. Estos roles no son categorías arbitrarias, sino que reflejan los cuatro tipos de actores reales que interactúan con la información del sistema, cada uno con necesidades y responsabilidades distintas.
