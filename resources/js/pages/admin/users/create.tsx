            ...
            <div className="mx-auto max-w-4xl p-4 lg:p-8">
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100">Registrar Nuevo Usuario</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid gap-6 rounded-xl border border-sidebar-border/70 p-6 md:grid-cols-2 dark:border-sidebar-border">
                        <div className="col-span-full mb-2 border-b pb-2">
                            ...
                            <p className="text-xs text-neutral-500">Configuración de credenciales de acceso.</p>
                        </div>
