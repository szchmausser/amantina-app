...
import { Edit, Plus, Save, Tag, Trash2 } from 'lucide-react';
...
export default function ActivityCategoriesIndex({ activityCategories }: Props) {
    ...
    const confirmDelete = () => {
        ...
        router.delete(`/admin/activity-categories/${pendingDeleteId}`);
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <AlertDialog open={confirmDialogOpen} onOpenChange={setConfirmDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>¿Eliminar categoría de actividad?</AlertDialogTitle>
                        <AlertDialogDescription>
                            Esta acción no se puede deshacer. La categoría de actividad será eliminada permanentemente.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
