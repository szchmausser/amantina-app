...
export default function FieldSessionEdit({
    fieldSession,
    teachers,
    statuses,
    activityCategories,
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        school_term_id: fieldSession.school_term_id?.toString() ?? '',
        user_id: fieldSession.user_id.toString(),
        activity_name: fieldSession.activity_name ?? '',
        location_name: fieldSession.location_name ?? '',
        start_datetime: formatDateTime(fieldSession.start_datetime),
        end_datetime: formatDateTime(fieldSession.end_datetime),
        status_id: fieldSession.status_id.toString(),
        cancellation_reason: fieldSession.cancellation_reason ?? '',
    });

    const [baseHours, setBaseHours] = useState<string>(fieldSession.base_hours);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        router.put(`/admin/field-sessions/${fieldSession.id}`, {
            name: data.name,
    ...
    const cancelledStatusId = statuses
        .find((s) => s.name === 'cancelled')
        ?.id.toString();
                    ...
                    <div className="space-y-4 rounded-xl border p-6">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                />
                                <InputError message={errors.activity_name} />
                            </div>
                            <div className="space-y-2">
