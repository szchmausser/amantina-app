...
class DashboardController extends Controller
{
    ...
    protected function adminDashboard(User $user, ?AcademicYear $year): Response
    {
        ...
        return Inertia::render('admin/dashboard', [
            ...
            'globalCompliance' => $overview['globalCompliance'] ?? [],
            'sectionRanking' => $overview['sectionRanking'] ?? [],
            'termComparison' => $overview['termComparison'] ?? [],
            'sessionStats' => $overview['sessionStats'] ?? [],
            'alerts' => $overview['alerts'] ?? [],
            'activityCategoryDistribution' => $overview['activityCategoryDistribution'] ?? [],
            'locationDistribution' => $overview['locationDistribution'] ?? [],
            'teacherWorkload' => $overview['teacherWorkload'] ?? [],
            'yearOverYear' => $overview['yearOverYear'] ?? [],
        ]);
    }
